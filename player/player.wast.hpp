...
(module
 ...
 (data (i32.const 32) "load_i64 == \00")
 (data (i32.const 48) "\n\00")
 (data (i32.const 64) "store_i64 == \00")
 (data (i32.const 80) "load\00")
 (export "memory" (memory $0))
 (export "_ZN6player4loadEv" (func $_ZN6player4loadEv))
 (export "init" (func $init))
 (export "apply" (func $apply))
 (func $_ZN6player4loadEv
  (local $0 i64)
  (local $1 i64)
  (local $2 i32)
  (local $3 i32)
